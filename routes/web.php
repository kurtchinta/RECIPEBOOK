...
Route::middleware(['auth', 'setDB'])->group(function () {
    ...
    Route::middleware('chef')->group(function () {
        ...
        Route::get('/chef/dashboard', [ChefController::class, 'dashboard'])->name(name: 'chef.dashboard');
        ...
        Route::put('/chef/recipes/{recipe}', [ChefController::class, 'updateRecipe'])->name('chef.updateRecipe'); // Add this line
