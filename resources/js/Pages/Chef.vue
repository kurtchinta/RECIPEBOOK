<template>
  ...
  <AuthenticatedLayout>
    <div class="min-h-screen bg-gray-50">
      ...
      <main class="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div v-if="!activeSection" class="max-w-4xl mx-auto">
  <div class="flex flex-col space-y-6">
    ...
    <!-- My Recipes -->
    <div class="bg-white p-6 rounded-lg shadow-sm" @click="setActiveSection('myRecipes')">
      <h2 class="text-lg sm:text-xl font-semibold mb-4 flex items-center text-gray-700">
      ...
      <div class="grid grid-cols-2 gap-4">
        ...
        <div v-else class="bg-white p-6 rounded-lg shadow-sm">
          <div class="flex items-center mb-4">
            <button
              class="mr-2 p-2 rounded-full bg-gray-200 hover:bg-gray-300 transition"
          ...
          <div v-if="activeSection === 'recipeManagement'">
            <!-- Recipe Management Content -->
            <p class="text-gray-700">Manage your recipes here.</p>
          </div>

          <div v-if="activeSection === 'myRecipes'">
            <!-- My Recipes Content -->
            <p class="text-gray-700">View all your recipes here.</p>
          </div>
        </div>
      </main>
